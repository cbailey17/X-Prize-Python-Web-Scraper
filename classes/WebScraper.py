# Webscraper class for x-prize competition for carbon capture technology
import requests
import os
import json
...
class WebScraper:
    ...
    def __int__(self, browser: str):
        self.browser = browser

    def authenticate_requests(self, url: str) -> requests.Session():
        """
    ...
    def selenium_setup(self): -> webdriver:
        """
